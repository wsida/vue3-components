<template>
	<view v-if="renderFlag" v-show="!isHidden" class="wpt-basic-popover">
		<view v-if="showMask && activeFullMask" :style="maskStyle" class="wpt-basic-popover__mask" @click="onClickMask"></view>
		<view v-if="showMask && !activeFullMask" :style="maskGroupStyle" class="wpt-basic-popover__mask-group" @click.stop="noop">
            <view class="wpt-basic-popover__mask-item is-box" :style="maskBoxStyle" @click="onClickMask"></view>
            <view class="wpt-basic-popover__mask-item is-top" :style="maskTopStyle" @click="onClickMask"></view>
            <view class="wpt-basic-popover__mask-item is-bottom" :style="maskBottomStyle" @click="onClickMask"></view>
            <view class="wpt-basic-popover__mask-item is-left" :style="maskLeftStyle" @click="onClickMask"></view>
            <view class="wpt-basic-popover__mask-item is-right" :style="maskRightStyle" @click="onClickMask"></view>
        </view>
		<view :style="popoverStyle" class="wpt-basic-popover__wrapper">
            <view v-if="activeShowTriangle" :style="triangleStyle" class="wpt-basic-popover__triangle"></view>
            <view class="wpt-basic-popover__content">
                <slot></slot>
            </view>
        </view>
	</view>
	...
	export default {
        ...
        methods: {
            ...
            updatePosition() {
                ...
                // console.log('>>>update position', this.targetRect, this.contentRect)
                ...
                if (!this.targetRect) {
                    ...
                    // 遮罩
                    const maskOffset = Math.max(0, (offset - (this.activeShowTriangle ? this.triangleSize / 2 : 0)) / 2);
                    // top
            ...
            getPopoverRect() {
                const contentView = uni.createSelectorQuery().in(this).select('.wpt-basic-popover__wrapper');
                if (contentView) {
...
.wpt-basic-popover__mask-item.is-box {
    background-color: rgba(255, 255, 255, .01);
}

.wpt-basic-popover__wrapper {
    position: fixed;
